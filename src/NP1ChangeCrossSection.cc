...
NP1ChangeCrossSection::NP1ChangeCrossSection(G4String particleName,
                                                         G4String         name)
  ...
  if ( fParticleToBias == 0 )
    {
      ...
      G4Exception("NP1ChangeCrossSection(...)","exNP1.01",JustWarning,ed);
    }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

NP1ChangeCrossSection::~NP1ChangeCrossSection()
{
...
void NP1ChangeCrossSection::StartRun()
{
  // --------------
  // -- Setup stage:
  // ---------------
...
G4VBiasingOperation* 
NP1ChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track,
                                                                               ...
                                                                               callingProcess)
{
  ...
  G4double XStransformation = NP1Control::GetInstance()->GetCSBiasFactor() ;
      ...
      if (  previousOperation != operation )
        {
          ...
          G4Exception("NP1ChangeCrossSection::ProposeOccurenceBiasingOperation(...)",
                      "exGB01.02",
                      JustWarning,
                      ed);
          return 0;
