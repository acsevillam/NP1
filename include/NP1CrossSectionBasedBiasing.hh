...
// ********************************************************************
//
/// \file GB01/include/NP1CrossSectionBasedBiasing.hh
/// \brief Definition of the NP1CrossSectionBasedBiasing class
//
//-----------------------------------------------------------------
//
...
#ifndef NP1CrossSectionBasedBiasing_hh
#define NP1CrossSectionBasedBiasing_hh 1

#include "G4VBiasingOperator.hh"
class NP1ChangeCrossSection;
class G4ParticleDefinition;

#include <map>

class NP1CrossSectionBasedBiasing : public G4VBiasingOperator {
public:
	NP1CrossSectionBasedBiasing();
	virtual ~NP1CrossSectionBasedBiasing() {}
...
private:
	...
	NP1ChangeCrossSection* >    fBOptrForParticle;
	std::vector < const G4ParticleDefinition* >   fParticlesToBias;
	NP1ChangeCrossSection*                  fCurrentOperator;
